...
<?php $this->end(); ?>
          ...
          <?= $this->element('reporting/pageScripts', array('reportType' => 'runCertificationReport', 'endUrl' => 'certification', 'templateContext' => 'ContactCertification')); ?>