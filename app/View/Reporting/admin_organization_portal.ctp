...
<div class="box">
            <div class="box-header">
                ...
                <h3 class="box-title"><em><strong>Organization Portal Subscriptions:</strong> <small>Reporting Options</small></em></h3>
    ...
    <div class='col-sm-12'>
        ...
        <?= $this->element('reporting/portal/portal'); ?>
    </div>
...
$conditions = {
           'andOr' : {
            ...
            'startDateBetween' : {
                type: 'double-string',
                conditionField: 'Portal.start_date',
            ...
            'endDateBetween' : {
                type: 'double-string',
                conditionField: 'Portal.end_date',
                conditionType: 'betweenDate',
                conditionSection: 'criteria',
                extra: null,
                data: null
            ...
            'checkAccessTypes' : {
                type: 'list',
                conditionField: 'Portal.access_type',
                conditionType: 'array',
                conditionSection: 'criteria',
                extra: null,
                data: null
        ...
        <?= $this->element('reporting/pageScripts', array(
            'reportType' => 'runOrganizationPortalReport', 
            'endUrl' => 'organization-portal', 
            'templateContext' => 'OrganizationPortal')); ?>
