...
<div class="box">
            <div class="box-header">
                ...
                <h3 class="box-title"><em><strong>Accreditations:</strong> <small>Reporting Options</small></em></h3>
...
*/
        ...
        <?= $this->element('reporting/pageScripts', array('reportType' => 'runAccreditationReport', 'endUrl' => 'accreditation', 'templateContext' => 'CustomerAccreditation')); ?>
