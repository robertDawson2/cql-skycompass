...
<div class="box">
            <div class="box-header">
                ...
                <h3 class="box-title"><em><strong>Organization Training:</strong> <small>Reporting Options</small></em></h3>
...
<script>
   ...
   $(".generateEmail").click(function() {
     ...
     //  console.log($sendData);
       $.ajax({
           type: 'post',
           url: '/admin/reporting/ajaxSendEmails/' + $("#EmailTemplateId").val() + '/organization-training',
           data: $sendData
...
// console.log($("#" + key).parent().parent().find('.data.end').val());
    ...
    function getConditions(conditionArray)
    {
       ...
       // console.log(conditionsObject);
        ...
        conditions = conditionsObject['training'];
        ...
        }).done(function(data)
        {
            if(data === "success")
            {
                $("#saveTemplateResult").html("<strong>Success!</strong> You have successfully saved this template.")
                        ...
                        .fadeIn('fast');
                $.ajax('/admin/reporting/ajaxGetTemplates/OrganizationTraining').done(function(data) {
    ...
    var condArray = getConditionsArray();
       ...
       $.ajax({
                type : 'json',
                method : 'post',
               url : '/admin/reporting/runOrganizationTrainingReport/OrganizationTraining',
               data : submission})
                   .done(function(data) {
                   //    console.log(data);
           id = data;
