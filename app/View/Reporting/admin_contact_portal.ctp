...
<div class="box">
            <div class="box-header">
                ...
                <h3 class="box-title"><em><strong>Contact Portal Subscriptions:</strong> <small>Reporting Options</small></em></h3>
...
$conditions = {
        ...
        <?= $this->element('reporting/pageScripts', array(
            'reportType' => 'runContactPortalReport', 
            'endUrl' => 'contact-portal', 
            'templateContext' => 'ContactPortal')); ?>
