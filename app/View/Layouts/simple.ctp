...
<head>
  ...
  <title>CQL SkyCompass | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="/admin">CQL <b>Sky</b>Compass</a>
  </div>
  <!-- /.login-logo -->
...
<div style="max-width: 300px; margin: 0 auto; height: 52px;">
    ...
    <form action="/admin/users/login" method="post">
      <div class="form-group has-feedback">
        <input type="email" name="data[Login][email]" class="form-control" placeholder="Email" autofocus>
