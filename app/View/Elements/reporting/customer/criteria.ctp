    ...
    <div class="box-body">
       <div class='row'>
        ...
        <div class='row'>
            ...
            <div class='col-md-8'>
                <div style = "float: right; "><a role='button' class='deepcategoryCheckAll'>Check</a> &nbsp;/  <a role='button' class='deepcategoryUncheckAll'>Uncheck</a></div>
                <?= $this->Form->input('Type.types', array('options' => $customerTypes, 'multiple', 'class' => 'input form-control data')); ?>
            </div>
        </div>
        ...
        <div class='row'>
            ...
            <div class='col-md-8'>
                <div style = "float: right; "><a role='button' class='deepcategoryCheckAll'>Check</a> &nbsp;/  <a role='button' class='deepcategoryUncheckAll'>Uncheck</a></div>
                <?= $this->Form->input('Source.sources', array('options' => $customerSources, 'multiple', 'class' => 'input form-control data')); ?>
            </div>
        </div>
            ...
            <div class='col-md-6'>
                <div class='row'>
                    ...
                    <?= $this->Form->input('contractExpiration', array(
                        'class' => 'input form-control datepicker data')); ?>
                    </div>
                </div>
                </div> 
