<?php $this->set('title_for_layout', 'New User'); ?>
<?php $this->set('breadcrumbs', array('/admin/users' => 'Manage Users', '-' => 'New User')); ?>
...
<div class="tab-content">
	<div class="tab-pane active" id="user">
		...
		<div class="row form-group">	
			<?php echo $this->Form->input('User.password', array('type' => 'password', 'div' => 'col-md-6', 'label' => 'Password', 'class' => 'input form-control')); ?>
