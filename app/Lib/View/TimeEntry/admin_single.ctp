              ...
              <div class="col-md-6">
                  ...
                  <h4>Duration</h4>
                      <TABLE><tr><td width='50%' style='padding: 5px;'>
                                   ...
                                   <div class='form-group'>
                                       <label>Hours</label>
                      <input name='data[TimeEntry][hours]' data-type="number"  class='form-control hour-spinner validation' data-required='required' default='0'>
                                   </div>
                              </td>
                              <td style='padding: 5px;'>
                                   ...
                                   <div class='form-group'>
                                       <label>Minutes</label>
                      <input  name='data[TimeEntry][minutes]' data-type='number'  class='form-control minute-spinner validation' data-required='required' default='0'>
                                   </div>
                              </td>
                          </tr>
                      </table>
